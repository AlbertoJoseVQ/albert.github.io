...
<head>
  <meta charset="utf-8" />
  <title>Un mensajito para ti ❤️</title>

  <!-- Vista previa para WhatsApp -->
  <meta property="og:title" content="💌 Sorpresa para ti" />
  <meta property="og:description" content="Haz click y mira este detalle con corazones ❤️" />
  ...
  <style>
    ...
    .card img{ width:100%; border-radius:16px; }
    h1{ margin:16px 0 6px; font-size:clamp(22px,3.5vw,34px); color:#b71c1c }
    p{ opacity:.9; line-height:1.5; margin:0 0 10px; color:#5d4037 }
    .btn{
...
<body>
  <div class="card">
    <img src="https://github.com/AlbertoJoseVQ/albert.github.io/blob/main/imagen_gato_flores.jpg" alt="Imagen bonita" />
